...
class OnTheAirPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocBuilder<OnTheAirTvSeriesBloc, OnTheAirTvSeriesState>(
        builder: (context, state) {
      if (state is OnTheAirTvSeriesLoadingState) {
        return const Center(
          child: CircularProgressIndicator(),
        );
      } else if (state is OnTheAirTvSeriesHasDataState) {
      ...
      } else if (state is OnTheAirTvSeriesErrorState) {
        return Center(
